...
declare function getTranslationsImpl<NestedKey extends NamespaceKeys<IntlMessages, NestedKeyOf<IntlMessages>> = never>(namespace?: NestedKey): Promise<{
...
declare const _default: typeof getTranslationsImpl;
